                    ...
                    <div className="recipe-detail-card_content">
                        <div className="recipe-detail-card_content-info">
                            ...
                            <div className="recipe-detail-card_ingredients">
                                {ingredients.map(e => detail[e] && <p>{detail[e]} <span className="recipe-detail-card_measure">({detail[`strMeasure${parseInt(e.replace('strIngredient', ''), 10)}`]})</span><span className="divider">,</span></p>)}
                            </div>
